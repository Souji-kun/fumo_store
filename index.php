...
// Use a single query to get all products
foreach ($categories as $category) {
    $products_by_category[$category] = getProducts($category, 6);
}
                ...
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        <div class="owl-men-item owl-carousel">
                            <?php 
                            if (isset($products_by_category['Plushies'])) {
                                echo displayProductCarousel($products_by_category['Plushies']);
                            }
                            ?>
                        </div>
                    </div>
